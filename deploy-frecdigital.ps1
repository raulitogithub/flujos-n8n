# =============================================================
# deploy-frecdigital.ps1  -  Despliega frecdigitalchat.json en n8n (Hetzner)
# Uso: .\deploy-frecdigital.ps1
...
$LOCAL_JSON   = "$PSScriptRoot\frecdigitalchat.json"
...
if ($exists) {
    ...
    try {
        ...
        $workflowObjClean.settings = @{ executionOrder = "v1" }
